...
{ //  category              name                      actor (function)         okSafeMode threadSafe reqWallet
  //  --------------------- ------------------------  -----------------------  ---------- ---------- ---------
    ...
    /* Yank features */
    { "yank",               "masternode",             &masternode,             true,      true,       false },
    { "yank",               "masternodelist",         &masternodelist,         true,      true,       false },
    { "yank",               "mnbudget",               &mnbudget,               true,      true,       false },
    { "yank",               "mnbudgetvoteraw",        &mnbudgetvoteraw,        true,      true,       false },
    { "yank",               "mnfinalbudget",          &mnfinalbudget,          true,      true,       false },
    { "yank",               "mnsync",                 &mnsync,                 true,      true,       false },
    { "yank",               "spork",                  &spork,                  true,      true,       false },
#ifdef ENABLE_WALLET
    { "yank",               "darksend",               &darksend,               false,     false,      true  }, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
         ...
         (mapArgs["-rpcuser"] == mapArgs["-rpcpassword"])) && Params().RequireRPCPassword())
    {
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
            _("To use yankd, or the -server option to yank-qt, you must set an rpcpassword in the configuration file:\n"
              "%s\n"
...
std::string HelpExampleCli(string methodname, string args){
    return "> yank-cli " + methodname + " " + args + "\n";
}

std::string HelpExampleRpc(string methodname, string args){
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
        "\"method\": \"" + methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:2882/\n";
}
