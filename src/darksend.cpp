...
/* *** BEGIN DARKSEND MAGIC - YANK **********
    Copyright (c) 2014-2015, Yank Developers
    ...
    if(fMasterNode) {
        ...
        BOOST_FOREACH(const CTransaction& txCollateral, vecSessionCollateral) {
            ...
            /*
                ...
                allow endless transaction that would bloat Yank and make it unusable. To
