    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Yank Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (about)
    {
        setWindowTitle(tr("About Yank Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  yank-qt [" + tr("command-line options") + "]                     " + "\n";
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Yank Core is shutting down...") + "<br /><br />" +
