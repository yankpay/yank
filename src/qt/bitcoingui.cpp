    ...
    spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Yank Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle *networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Yank address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and yank: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Yank Core"), this);
    aboutAction->setStatusTip(tr("Show information about Yank Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Yank"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Yank addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Yank addresses"));
    ...
    openAction->setStatusTip(tr("Open a yank: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Yank Core help message to get a list with possible Yank command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Yank Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Yank network", "", count));
}
...
{
    QString strTitle = tr("Yank Core"); // default title
