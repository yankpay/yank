...
Only requiring some minor changes is yank.cpp.
...
Changes to yank.cpp
----------------------
yank.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
